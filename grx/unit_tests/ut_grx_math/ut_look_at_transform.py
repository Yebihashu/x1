...
def test_look_at_transform__no_transform():
    transform_results = grx_math.look_at_transform(position=np.array([0.0,0.0,0.0]),
                               look_at_position=np.array([0.0,0.0,100.0]), 
...
def test_look_at_transform__H100_pitch_m45():
    transform_results = grx_math.look_at_transform(position=np.array([0.0,100.0,0.0]),
                               look_at_position=np.array([0.0,0.0,100.0]), 
                               strive_up=np.array([0.0,1.0,0.0]))
